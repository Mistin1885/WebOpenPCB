...
//
// Source: src/sdks/designer/contracts/RouteResultEnvelope.schema.json (vendored from cloud-auto-layout's
// `contracts/RouteResultEnvelope.schema.json` — see that dir's README.md for provenance + sync instructions).
//
