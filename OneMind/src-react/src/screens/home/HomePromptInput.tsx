...
import { AIChatPromptInput, type PromptInputMessage } from "@/components/ai-elements/prompt-input";
...
export function HomePromptInput() {
  ...
  const { navigateToChat, currentScreen, folderFilter } = useNavigationStore();
  const activeWorkspaceId = useAppStore((state) => state.activeWorkspaceId);
  const isVisible = currentScreen === "home" && !folderFilter;
  ...
  }, [createNewChat, currentConfig, pendingModelSelection, activeWorkspaceId, setPendingInitialMessage, navigateToChat]);
