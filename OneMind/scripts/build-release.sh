...
if [ -z "${TAURI_SIGNING_PRIVATE_KEY:-}" ]; then
  ...
  echo "Generate with: cargo tauri signer generate -w ~/.tauri/onemind.key"
  exit 1
fi
...
echo "Updater endpoint: https://raw.githubusercontent.com/andrejvysny/OneMindReleases/main/latest.json"
