...
const originalState = process.env.ONEMIND_STARTUP_LICENSE_STATE;
const originalCode = process.env.ONEMIND_STARTUP_LICENSE_CODE;

const restoreEnv = () => {
  if (originalState === undefined) {
    delete process.env.ONEMIND_STARTUP_LICENSE_STATE;
  } else {
    process.env.ONEMIND_STARTUP_LICENSE_STATE = originalState;
  }

  if (originalCode === undefined) {
    delete process.env.ONEMIND_STARTUP_LICENSE_CODE;
  } else {
    process.env.ONEMIND_STARTUP_LICENSE_CODE = originalCode;
  }
};
