...
export const ALL_MODULE_MANIFESTS: GeneratedModuleManifest[] = [
    ...
    },
    {
        ...
        dependsOn: [],
        exports: {"services":[{"id":"knowledge.pages","kind":"http","description":"Page CRUD API"},{"id":"knowledge.search","kind":"http","description":"Page search API"},{"id":"knowledge.mentions","kind":"http","description":"Chat mention resolution"}],"widgets":[]},
        registerAsSpaceInTopBar: true,
        defaultPinned: true,
        resolvedDependencies: [],
        loadOrder: 1
