...
const LICENSE_API_URL = process.env.ONEMIND_LICENSE_API_URL || "";
const LICENSE_API_KEY = process.env.ONEMIND_LICENSE_API_KEY || "";
...
function deviceId(): string {
  return process.env.ONEMIND_DEVICE_ID || "unknown";
}
