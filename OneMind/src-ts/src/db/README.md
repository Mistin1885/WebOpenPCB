...
This directory contains the database access layer for the OneMind Bun TypeScript sidecar.
...
```env
# .env file
DB_FILE_PATH=./data/OneMind.db  # SQLite database file path
...
export default defineConfig({
  ...
  dbCredentials: {
    url: process.env.DB_FILE_PATH || './data/OneMind.db',
  },
});
```
...
2. `${APP_DATA_DIR}/OneMind.db` (set by Rust layer)
3. `./data/OneMind.db` (fallback)
...
- [Architecture Spec V3](../../../OneMind_Architecture_V3_Specification.md) - Part 7
