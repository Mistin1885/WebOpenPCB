 ...
 * - OneMind_ENV: Environment (development, production, test)
 * - OneMind_DATA_PATH: Data storage path
 * - OneMind_LOG_LEVEL: Log level
 * - OneMind_PORT: Server port
 * - OneMind_HOST: Server hostname
